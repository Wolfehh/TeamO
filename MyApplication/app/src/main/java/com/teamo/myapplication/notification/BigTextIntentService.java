...
import com.teamo.myapplication.GlobalNotificationBuilder;
...
public class BigTextIntentService extends IntentService {
    ...
    public static final String ACTION_DISMISS =
            "com.teamo.myapplication.handlers.action.DISMISS";
    public static final String ACTION_SNOOZE =
            "com.teamo.myapplication.handlers.action.SNOOZE";
    ...
    private NotificationCompat.Builder recreateBuilderWithBigTextStyle() {
        ...
        NotificationCompat.Action snoozeAction =
                new NotificationCompat.Action.Builder(
                        R.drawable.ic_alarm_white_48dp,         //ADD IMAGE
                        "Snooze",
                        snoozePendingIntent)
                        .build();
        ...
        NotificationCompat.Action dismissAction =
                new NotificationCompat.Action.Builder(
                        R.drawable.ic_cancel_white_48dp,        //ADD IMAGE
                        "Dismiss",
